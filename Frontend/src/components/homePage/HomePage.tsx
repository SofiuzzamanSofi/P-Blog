            ...
            <header className="p-4">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 md:flex">
                        ...
                        <li className="flex">
                            <a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Blog</a>
                        </li>
                        <li className="flex">
            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
                ...
                <form className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div>
                        ...
                        <textarea id="message" rows={3} className="w-full p-3 rounded dark:bg-gray-800" data-gramm="false" wt-ignore-input="true"></textarea>
                    </div>
                ...
                <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row">
                    ...
                    <div className="flex flex-col justify-center pt-6 lg:pt-0">
                        <div className="flex justify-center space-x-4">
                            <a rel="noopener noreferrer" href="#" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900">
